...
export async function calculateRelevanceScore(
    ...
    const typeFactor = post.attachments.length > 0 ? 1.5 : 1; // Bonus si le post contient des médias
    ...
    return engagementScore * timeFactor + proximityScore + typeFactor + latestPostBonus;
  }
