export const english = {
  ...
  unsupportedEnv: "Environment not supported. Make sure your browser or application is up to date or visit the official website to log in.",
  ...
  leaveGroupInfo: "If you leave without deleting the group the oldest member will receive your privileges",
...
export const french: Vocabulary = {
  ...
  unsupportedEnv: "Environnement non pris en charge. Assurez-vous que votre navigateur ou application est à jour ou visitez le site officiel pour vous connecter",
  ...
  leaveGroupInfo: "Si vous quittez sans supprimer le groupe le membre le plus ancien recevra vos privileges",
  thisGroup: "Ce groupe",
