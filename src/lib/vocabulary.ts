export const english = {
  ...
  unsupportedEnv: "Unsupported environment. Update your browser or app, or visit the official site to log in.",
...
export const french: Vocabulary = {
  ...
  unsupportedEnv: "Environnement non supporté. Mettez à jour votre navigateur ou application, ou visitez le site officiel pour vous connecter.",
